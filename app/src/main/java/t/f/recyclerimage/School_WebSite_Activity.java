...
public class School_WebSite_Activity extends Activity {
    ...
    private void initView() {
        ...
        xiecheng_url=getIntent().getStringExtra("WEBSITE");
        webView.loadUrl(xiecheng_url);

        webView.addJavascriptInterface(School_WebSite_Activity.this,"android");

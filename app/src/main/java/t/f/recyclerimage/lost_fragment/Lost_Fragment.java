...
public class Lost_Fragment extends Fragment implements OnLoadMoreListener,OnRefreshListener{
        ...
        OkHttpUtils.get().url(url).build().execute(new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                try {
                    ...
                    Log.i(TAG,"有"+jsonArray.length()+"条数据");
        ...
        OkHttpUtils.get().url(url).build().execute(new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                try {
                    ...
                    adapter.notifyItemRangeInserted(count*10,jsonArray.length());
